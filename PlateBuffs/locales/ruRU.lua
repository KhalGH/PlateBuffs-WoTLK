...
L["Duration Reduction"] = "Сокращение продолжительности"
L["Forces a duration reduction factor on all interrupts to conservatively handle healer talents cases (up to 30%)."] = "Принудительно применяет коэффициент сокращения длительности ко всем прерываниям, чтобы консервативно учитывать случаи с талантами целителей (до 30%)."